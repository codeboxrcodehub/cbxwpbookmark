...
final class ValueTest extends TestCase
{
    ...
    {
        return ['calc' => ['to be parsed' => 'calc(%s);', 'expected' => 'calc(%s)'], 'max' => ['to be parsed' => 'max(300px, %s);', 'expected' => 'max(300px,%s)']];
    }
    /**
     * @test
     *
     ...
     */
    public function parsesArithmeticWithMultipleOperatorsInFunctions($parserTemplate, $expectedResultTemplate)
    {
    ...
    {
        return ['LHS missing number' => ['vh', '10px'], 'RHS missing number' => ['50vh', 'px'], 'LHS missing unit' => ['50', '10px'], 'RHS missing unit' => ['50vh', '10']];
    }
    /**
     * @test
     *
    ...
    {
        $subject = Value::parseValue(new ParserState('max(300px, ' . $leftOperand . ' + ' . $rightOperand . ');', Settings::create()));
