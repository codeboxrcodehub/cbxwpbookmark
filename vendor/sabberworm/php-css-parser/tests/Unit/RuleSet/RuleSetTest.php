...
namespace CBXWPBookmarkScoped\Sabberworm\CSS\Tests\Unit\RuleSet;
...
use CBXWPBookmarkScoped\Sabberworm\CSS\Tests\Unit\RuleSet\Fixtures\ConcreteRuleSet;
use CBXWPBookmarkScoped\TRegx\DataProvider\DataProviders;
/**
...
final class RuleSetTest extends TestCase
{
    ...
    {
        return ['no properties' => [[]], 'one property' => [['color']], 'two different properties' => [['color', 'display']], 'two of the same property' => [['color', 'color']]];
    }
    /**
    ...
    {
        return ['property name `color` maybe matching that of existing declaration' => ['color'], 'property name `display` maybe matching that of existing declaration' => ['display'], 'property name `width` not matching that of existing declaration' => ['width']];
    }
    /**
     ...
     */
    public function addRuleWithoutSiblingAddsRuleAfterInitialRulesAndSetsValidLineAndColumnNumbers(array $initialPropertyNames, string $propertyNameToAdd)
    {
        $subject = new ConcreteRuleSet();
     ...
     * @param list<string> $initialPropertyNames
     */
    public function addRuleWithOnlyLineNumberAddsRuleAndSetsColumnNumberPreservingLineNumber(array $initialPropertyNames, string $propertyNameToAdd)
    {
        $subject = new ConcreteRuleSet();
        $ruleToAdd = new Rule($propertyNameToAdd);
     ...
     * @param list<string> $initialPropertyNames
     */
    public function addRuleWithOnlyColumnNumberAddsRuleAfterInitialRulesAndSetsLineNumberPreservingColumnNumber(array $initialPropertyNames, string $propertyNameToAdd)
    {
        $subject = new ConcreteRuleSet();
        $ruleToAdd = new Rule($propertyNameToAdd);
     ...
     * @param list<string> $initialPropertyNames
     */
    public function addRuleWithCompletePositionAddsRuleAndPreservesPosition(array $initialPropertyNames, string $propertyNameToAdd)
    {
        $subject = new ConcreteRuleSet();
        $ruleToAdd = new Rule($propertyNameToAdd);
     ...
     */
    public function removeMatchingRulesRemovesRulesByPropertyNameAndKeepsOthers(array $initialPropertyNames, $propertyNameToRemove, array $expectedRemainingPropertyNames)
    {
        $subject = new ConcreteRuleSet();
        self::setRulesFromPropertyNames($subject, $initialPropertyNames);
     ...
     */
    public function removeMatchingRulesRemovesRulesByPropertyNamePrefixAndKeepsOthers(array $initialPropertyNames, $propertyNamePrefix, array $expectedRemainingPropertyNames)
    {
    ...
    {
        $subject->setRules(\array_map(function ($propertyName) {
