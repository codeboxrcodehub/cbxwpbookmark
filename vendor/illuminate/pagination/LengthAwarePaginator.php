...
use ArrayAccess;
use Countable;
use CBXWPBookmarkScoped\Illuminate\Contracts\Pagination\LengthAwarePaginator as LengthAwarePaginatorContract;
...
class LengthAwarePaginator extends AbstractPaginator implements Arrayable, ArrayAccess, Countable, IteratorAggregate, Jsonable, JsonSerializable, LengthAwarePaginatorContract
{
    ...
    public function linkCollection()
    {
        ...
        })->prepend(['url' => $this->previousPageUrl(), 'label' => function_exists('CBXWPBookmarkScoped\__') ? __('pagination.previous') : 'Previous', 'active' => \false])->push(['url' => $this->nextPageUrl(), 'label' => function_exists('CBXWPBookmarkScoped\__') ? __('pagination.next') : 'Next', 'active' => \false]);
    }
    /**
