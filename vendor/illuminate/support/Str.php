...
use CBXWPBookmarkScoped\League\CommonMark\GithubFlavoredMarkdownConverter;
use CBXWPBookmarkScoped\Ramsey\Uuid\Codec\TimestampFirstCombCodec;
use CBXWPBookmarkScoped\Ramsey\Uuid\Generator\CombGenerator;
use CBXWPBookmarkScoped\Ramsey\Uuid\Uuid;
use CBXWPBookmarkScoped\Ramsey\Uuid\UuidFactory;
use CBXWPBookmarkScoped\voku\helper\ASCII;
class Str
{
    use Macroable;
    /**
