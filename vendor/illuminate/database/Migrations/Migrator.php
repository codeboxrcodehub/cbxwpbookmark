...
namespace CBXWPBookmarkScoped\Illuminate\Database\Migrations;

use CBXWPBookmarkScoped\Doctrine\DBAL\Schema\SchemaException;
...
use CBXWPBookmarkScoped\Illuminate\Database\Events\MigrationEnded;
use CBXWPBookmarkScoped\Illuminate\Database\Events\MigrationsEnded;
use CBXWPBookmarkScoped\Illuminate\Database\Events\MigrationsStarted;
use CBXWPBookmarkScoped\Illuminate\Database\Events\MigrationStarted;
use CBXWPBookmarkScoped\Illuminate\Database\Events\NoPendingMigrations;
...
use ReflectionClass;
use CBXWPBookmarkScoped\Symfony\Component\Console\Output\OutputInterface;
class Migrator
{
    /**
