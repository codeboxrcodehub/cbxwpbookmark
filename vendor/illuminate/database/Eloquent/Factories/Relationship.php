...
use CBXWPBookmarkScoped\Illuminate\Database\Eloquent\Relations\HasOneOrMany;
use CBXWPBookmarkScoped\Illuminate\Database\Eloquent\Relations\MorphOneOrMany;
class Relationship
{
    /**
