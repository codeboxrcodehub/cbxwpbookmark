...
namespace CBXWPBookmarkScoped\Illuminate\Database\Console\Factories;

use CBXWPBookmarkScoped\Illuminate\Console\GeneratorCommand;
...
class FactoryMakeCommand extends GeneratorCommand
{
    ...
    protected function buildClass($name)
    {
        ...
        if (Str::startsWith($namespaceModel, $this->rootNamespace() . 'Models')) {
            ...
            $namespace = 'CBXWPBookmarkScoped\Database\Factories';
        }
