...
use CBXWPBookmarkScoped\Doctrine\DBAL\Connection as DoctrineConnection;
use CBXWPBookmarkScoped\Doctrine\DBAL\Types\Type;
use Exception;
use CBXWPBookmarkScoped\Illuminate\Contracts\Events\Dispatcher;
use CBXWPBookmarkScoped\Illuminate\Database\Events\QueryExecuted;
use CBXWPBookmarkScoped\Illuminate\Database\Events\StatementPrepared;
use CBXWPBookmarkScoped\Illuminate\Database\Events\TransactionBeginning;
use CBXWPBookmarkScoped\Illuminate\Database\Events\TransactionCommitted;
use CBXWPBookmarkScoped\Illuminate\Database\Events\TransactionRolledBack;
use CBXWPBookmarkScoped\Illuminate\Database\Query\Builder as QueryBuilder;
use CBXWPBookmarkScoped\Illuminate\Database\Query\Expression;
use CBXWPBookmarkScoped\Illuminate\Database\Query\Grammars\Grammar as QueryGrammar;
use CBXWPBookmarkScoped\Illuminate\Database\Query\Processors\Processor;
use CBXWPBookmarkScoped\Illuminate\Database\Schema\Builder as SchemaBuilder;
...
class Connection implements ConnectionInterface
{
    ...
    {
        return class_exists('CBXWPBookmarkScoped\Doctrine\DBAL\Connection');
    }
    /**
