 ...
 */
namespace CBXWPBookmarkScoped\Carbon\Traits;

use CBXWPBookmarkScoped\Carbon\CarbonInterface;
use CBXWPBookmarkScoped\Carbon\Exceptions\InvalidTypeException;
use CBXWPBookmarkScoped\Carbon\Exceptions\NotLocaleAwareException;
use CBXWPBookmarkScoped\Carbon\Language;
use CBXWPBookmarkScoped\Carbon\Translator;
use CBXWPBookmarkScoped\Carbon\TranslatorStrongTypeInterface;
use Closure;
use CBXWPBookmarkScoped\Symfony\Component\Translation\TranslatorBagInterface;
use CBXWPBookmarkScoped\Symfony\Component\Translation\TranslatorInterface;
use CBXWPBookmarkScoped\Symfony\Contracts\Translation\LocaleAwareInterface;
use CBXWPBookmarkScoped\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
// @codeCoverageIgnoreStart
if (interface_exists('CBXWPBookmarkScoped\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('CBXWPBookmarkScoped\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('CBXWPBookmarkScoped\Symfony\Contracts\Translation\TranslatorInterface', 'CBXWPBookmarkScoped\Symfony\Component\Translation\TranslatorInterface');
}
