...
namespace CBXWPBookmarkScoped\enshrined\svgSanitize\ElementReference;

use CBXWPBookmarkScoped\enshrined\svgSanitize\data\XPath;
use CBXWPBookmarkScoped\enshrined\svgSanitize\Exceptions\NestingException;
use CBXWPBookmarkScoped\enshrined\svgSanitize\Helper;
class Resolver
{
    /**
     * @var XPath
