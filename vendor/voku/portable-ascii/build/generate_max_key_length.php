...
$languages = \CBXWPBookmarkScoped\voku\helper\ASCII::getAllLanguages();
$languagesKeyLengths = [];
foreach ($languages as $language) {
    $langSpecific = \CBXWPBookmarkScoped\voku\helper\ASCII::charsArrayWithOneLanguage($language, \false, \false);
