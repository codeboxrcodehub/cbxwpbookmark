<?php
//namespace CBXWPBookmark\Widgets\Classic\MyBookmark;
 ...
 *
 * Class CBXWPBookmarkMyBookmarkWidget
 */
class CBXWPBookmarkMyBookmarkWidget extends WP_Widget {
	/**
	 *
...
}//end CBXWPBookmarkMyBookmarkWidget