<?php
//namespace Cbx\Bookmark\Helpers;
			...
			[
				'cbxwpbookmark_basics' => [
					...
					'user_dashboard_page' => [
						...
						'desc'              => esc_html__( 'Select the page where you have placed the [cbxwpbookmark_user_dashboard] shortcode. This user dashboard page/shortcode helps to display multiple user related shortcodes/components/functionalities.', 'cbxwpbookmark' ),
						'type'              => 'page',
