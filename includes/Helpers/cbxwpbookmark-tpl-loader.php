 ...
 * @param  string  $default_path  Default path. (default: '').
 */
function cbxwpbookmark_get_template( $template_name, $args = [], $template_path = '', $default_path = '' ) {
 ...
 * @see   wc_get_template
 */
function cbxwpbookmark_get_template_html( $template_name, $args = [], $template_path = '', $default_path = '' ) {
	ob_start();
